...
class RotatingTriangle {
  ...
  RotatingTriangle() {
    ...
    var upButton = querySelector("#upButton");
    upButton.onClick.listen((ev) => upClick(ev));
    
    var downButton = querySelector("#downButton");
    downButton.onClick.listen((ev) => downClick(ev));
